...
def main(cfg: FairseqConfig) -> None:
    ...
    # Print args
    ## TODO: check if args state the merging dataset and technique
    logger.info(cfg)
    ...
    # TODO: initialize parameters as average of model pairs
...
def should_stop_early(cfg: DictConfig, valid_loss: float) -> bool:
    ...
    if rpev_best is None or is_better(valid_loss, prev_best):
