...
@dataclass
class MultidomainLMMergingConfig(FairseqDataclass):
...
@register_task("multidomain_lm_mergin", dataclass=MultidomainLMMergingConfig)
class MultidomainLanguageModelingTask(LegacyFairseqTask):
    ...
    def bezier_curve(alpha,  model, models):
        pass
    ...
    def train_step(
        ...
        with torch.autograd.profiler.record_function("forward"):
            with torch.cuda.amp.autocast(enabled=(isinstance(optimizer, AMPOptimizer))):
                ...
                ## TODO: set model parameters based on bezier curve
                ## TODO: How to pass in anchor models?
        ...
        ## Set model parameters and grad according to Bezier computation
